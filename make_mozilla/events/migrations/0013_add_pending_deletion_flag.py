...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.pending_deletion'
        db.add_column('events_event', 'pending_deletion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.pending_deletion'
        db.delete_column('events_event', 'pending_deletion')
