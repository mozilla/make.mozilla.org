...
urlpatterns = patterns('',
    ...
    url(r'^all/$',
        views.all,                  name='events.all'),
    url(r'^in/(?P<code>[a-z]{2})/$',
        views.country,              name='events.country'),
    url(r'^in/(?P<code>[a-z]{2})/map/$',
        views.country_map,          name='events.country.map'),
    url(r'^near/$',
    ...
    url(r'^live-updates/$',
        views.scribble_live,        name='scribble_live'),
    ...
    url(r'^mine/$',
        views.mine,                 name='events.mine'),
    url(r'^(?P<event_id>\d+)/$',
        views.from_id,              name='event.from_id'),
    url(r'^(?P<event_hash>[a-z0-9]{9,})/$',
        views.details,              name='event'),
    url(r'^(?P<event_hash>[a-z0-9]{9,})/edit/$',
        views.edit_or_update,       name='event.edit'),
    url(r'^(?P<event_hash>[a-z0-9]{9,})/delete/$',
        views.delete,               name='event.delete'),
)
