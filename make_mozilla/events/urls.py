...
urlpatterns = patterns('',
    ...
    url(r'^guides/kitchen-table/$',        views.guides_template,   name='guides_kitchen-table'),
    url(r'^guides/hack-jam/$',      views.guides_template, name='guides_hack-jam'),
    url(r'^guides/pop-up/$',        views.guides_template, name='guides_pop-up'),
